...
<head>
 ...
 <body>
    ...
    <h1><center>Faculty Updates</center></h1><br></div>
  ...
  <tr>
      ...
      <td><br>
        <input type="text" pattern="[a-zA-Z ]+" name="department" id="" placeholder="" class="tbb"  required title="" ><br><br>
      </td>
    </tr>
             ...
             <td>". $row['slno'] . "</td>
              ...
              <td>" . $row['department'] ."</td>
               ...
               alt="Image" style="width:50px; height:50px;"> '. "</td>
                <td><a href='delete-fac.php?slno=$row[slno]' onclick='checkdelete()'>DELETE</a></td>
          </tr>
            ";
          }
