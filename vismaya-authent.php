...
<html>
<head>
	<title>Vismaya Gallery Updates</title>
</head>
<body>
	<?php
    ...
    if(isset($_POST['table']))
    {
        ...
        $query= "INSERT INTO vismaya_gal VALUES ('$slno','$file')";
	  ...
	  if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
        ...
        if($query_run){
					echo '<script type="text/javascript">alert("Vismaya Image Updated Successfully")</script>';
					?>
