...
<html>
<head>
	<title>Event Gallery Updates</title>
</head>
<body>
	<?php
    ...
    if(isset($_POST['table']))
    {
        ...
        $query= "INSERT INTO event_gal VALUES ('$slno','$file')";
	  ...
	  if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
		...
		if($query_run){
			echo '<script type="text/javascript">alert("Event Image Updated Successfully")</script>';
			?>
